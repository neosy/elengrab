...
// FetchLinksInHead downloads the HTML from the given URL and extracts all <link> tags
...
func FetchLinksInHead(ctx context.Context, url string, opts ...any) ([][]html.Attribute, error) {
	var (
