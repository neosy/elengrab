...
// FetchHTML performs an HTTP GET request using net/http and returns
...
//   - MethodGetOptions   : general options for retrieval (e.g., limit, etc.)
...
func FetchHTML(ctx context.Context, url string, opts ...any) ([]byte, error) {
	var (
