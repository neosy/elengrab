...
func (s *httpServer) setupStaticRoutes(r *router.Router, handlers *statich.StaticHandlers) {
	...
	g.Use(middlewareError)
	{
		...
		g.GET(httppaths.PathFontFiles, handlers.Static.StaticFontsHandler)
		g.HEAD(httppaths.PathFontFiles, handlers.Static.StaticFontsHandler)
		g.GET(httppaths.PathImageFiles, handlers.Static.StaticImgHandler)
		g.HEAD(httppaths.PathImageFiles, handlers.Static.StaticImgHandler)
